...
// export const _changeMonitoraClient = (token, id_client, monitora) => {
//   return axios.post(url_change_monitora_client, {
//     token: token,
//     id_client: String(id_client),
//     monitora: monitora
//   })
...
export const _addTier = (token, id_company, tier_name) => {
  return axios.post(url_add_tier, {
    token: token,
    id_company: String(id_company),
    tier_name: tier_name
  })
...
export const _removeTier = (token, id_company, tier_name) => {
  return axios.post(url_remove_tier, {
    token: token,
    id_company: String(id_company),
    tier_name: tier_name
  })
...
export const _updateTier = (token, ids_client, tier_name) => {
  return axios.post(url_update_tier, {
    token: token,
...
export const _getTypeFromClient = (token, id_client) => {
  return axios.post(url_get_type_from_client, {
    token: token,
    id_client: String(id_client),
  })
}

export const _getClientOfTier = (token, tier_name, id_company) => {
  return axios.post(url_get_client_of_tier, {
    token: token,
    tier_name: tier_name,
    id_company: String(id_company),
  })
