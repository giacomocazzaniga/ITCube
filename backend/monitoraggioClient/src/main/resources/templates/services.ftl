    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
      <tr>
        ...
        <td class="container">
          <div class="content">
                <h1>ITSentinel</h1>
                <center><h3>${info.nome_client} @ ${info.nome_company}</h3></center>
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <center><p>Il servizio <strong>${info.nome_servizio}</strong> risulta essere in uno stato di <strong>${info.tipologia_alert}</strong>!</p></center>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td><center><small>${info.date_and_time_alert}<small></center></td>
                                </tr>
                            </tbody>
                        </table>
                      </td>
